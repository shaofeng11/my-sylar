...
uint64_t HttpRequestParser::GetHttpRequestMaxBodyize(){
...
uint64_t HttpResponseParser::GetHttpResponseMaxBodyize(){
    return s_http_request_max_body_size;
}
namespace{
//在main函数之前执行
...
HttpRequestParser::HttpRequestParser()
    ...
    m_parser.request_method=on_request_method;//解析method
