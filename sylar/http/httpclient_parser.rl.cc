...
{	
	...
	
	{
		...
		ctr9:
		{
			#line 22 "httpclient_parser.rl"
			
			parser->field_len = LEN(field_start, p);
		}
		{
			#line 26 "httpclient_parser.rl"
			MARK(mark, p); }
		{
			#line 36 "httpclient_parser.rl"
